...
- **Standard Ease**: `cubic-bezier(0.25, 0.1, 0.25, 1)`
  _Default smooth transition curve._
- **Enter Ease (easeOutExpo)**: `cubic-bezier(0.16, 1, 0.3, 1)`
  _High initial speed tapering to a slow slide. Used for card load states and text reveals._
- **Exit Ease (easeInExpo)**: `cubic-bezier(0.7, 0, 0.84, 0)`
  _Slow exit acceleration. Used for collapsing drawers and closed elements._
- **Emphasised Ease**: `cubic-bezier(0.85, 0, 0.15, 1)`
  _Pronounced deceleration curve for major transitions._

### Spring Constants (Framer Motion)

- **Fast/Bouncy Spring**: `stiffness: 300, damping: 20`
  _Used for magnetic buttons and cursor glow movements._
- **Slow/Smooth Spring**: `stiffness: 200, damping: 30`
  _Used for parallax offsets and page scroll fade-ins._
