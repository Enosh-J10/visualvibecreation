...
export default function NotFound() {
  return (
    <main className="flex-grow flex flex-col justify-center py-20">
      <Container variant="reading" className="text-center flex flex-col items-center justify-center space-y-6 relative overflow-hidden">
        ...
        <h1 className="font-display text-7xl font-extrabold tracking-wider text-white z-10">
          404
        </h1>
