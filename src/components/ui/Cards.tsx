  ...
  return (
    <CardWrapper interactive={false} className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
        ...
        <div className="inline-flex items-center gap-1.5 text-[10px] font-mono text-text-secondary bg-white/[0.02] border border-border-subtle px-2.5 py-1 rounded-md max-w-max">
