...
import { motion, useMotionValue, useSpring, useTransform, useScroll, useMotionTemplate, useReducedMotion } from "framer-motion";
...
export default function InteractiveBackground() {
  ...
  useEffect(() => {
    ...
    const sections = ["hero", "focus", "fincalc", "journey", "visual-vibe", "experience", "education", "awards", "contact"];
  ...
  }[activeSection] || { left: "50%", top: "50%", scale: 1.0, opacity: 0.07, bg: "rgb(165, 243, 252)" };
